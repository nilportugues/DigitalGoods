        ...
        <div className="column card w-500">
          ...
          <Formik
            ...
            onSubmit={values => {
              ...
              console.log(values);
              this.registerHandler(values.email, values.password, values.firstName, values.lastName)
              ...
              <Form className="mt-60">
                ...
                <div className="field">
                  ...
                  <div className="control">
                    ...
                    <Field type="text" name="firstName" placeholder="First Name" className="input is-medium"/>
                ...
                <div className="field">
                  ...
                  <div className="control">
                    ...
                    <Field type="text" name="lastName" placeholder="Last Name" className="input is-medium"/>
